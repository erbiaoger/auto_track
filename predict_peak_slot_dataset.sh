...
DATA_DIR=${DATA_DIR:-datasets/peak_slot_v3_120s_realistic/test}                # 待预测的数据目录
MODEL=${MODEL:-models/peak_slot_v3_120s_realistic_cuda/checkpoint_best.pt}     # checkpoint 路径
OUT_DIR=${OUT_DIR:-models/peak_slot_v3_120s_realistic_cuda/prediction_check}   # 预测结果输出目录
