...
DATA_DIR=${DATA_DIR:-datasets/peak_slot_v2/test}
MODEL=${MODEL:-models/peak_slot_v2_cuda/checkpoint_best.pt}
OUT_DIR=${OUT_DIR:-models/peak_slot_v2_cuda/prediction_check}
DEVICE=${DEVICE:-cpu}
...
MAX_PREDICTED_TRACKS=${MAX_PREDICTED_TRACKS:-64}
MATCHER=${MATCHER:-hungarian}
DECODER_MODE=${DECODER_MODE:-beam_global}
VITERBI_BEAM_SIZE=${VITERBI_BEAM_SIZE:-4}
