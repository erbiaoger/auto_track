...
def proposal_heatmap_loss(outputs: dict[str, torch.Tensor], target_heatmap: torch.Tensor, *, dice_weight: float = 0.25) -> torch.Tensor:
...
def vehicle_proposal_loss(
    ...
    *,
    ...
    loss_heatmap = proposal_heatmap_loss(outputs, target_heatmap, dice_weight=float(dice_weight))
