...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--objectness-threshold", type=float, default=0.35, help="Query objectness threshold.")
    parser.add_argument("--visibility-threshold", type=float, default=0.5, help="Per-channel visibility threshold.")
    parser.add_argument("--min-visible-channels", type=int, default=2, help="Minimum visible points per trajectory.")
