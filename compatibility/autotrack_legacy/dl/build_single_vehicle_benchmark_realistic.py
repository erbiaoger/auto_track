"""Build a realistic single-vehicle benchmark for the 50-channel task.

This is a narrow single-vehicle benchmark generator tuned for the current
problem statement:

- 50 channels
- 100 m channel spacing
- 120 s windows
- vehicle speeds around 70-90 km/h

The goal is to produce a near-ideal synthetic benchmark for the single-vehicle
network, while still allowing optional real backgrounds and localized artifacts
that stress the post-processing stack.
"""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build a realistic single-vehicle benchmark.")
    ...
    parser.add_argument("--artifact-dropout-ratio", type=float, default=0.55, help="Chance to remove a contiguous block of visible channels.")
    ...
    parser.add_argument("--artifact-decoy-ratio", type=float, default=0.75, help="Chance to inject a decoy branch or spike cluster.")
    ...
    parser.add_argument("--artifact-competing-ratio", type=float, default=0.65, help="Chance to inject an unlabeled competing vehicle track.")
    ...
    parser.add_argument("--artifact-competing-amp-scale-max", type=float, default=1.5, help="Maximum competing-vehicle amplitude scale relative to the true track.")
