...
DATA_DIR=${DATA_DIR:-datasets/peak_slot_v5_120s_ponytail/train}
VAL_DATA_DIR=${VAL_DATA_DIR:-datasets/peak_slot_v5_120s_ponytail/test}
OUT_DIR=${OUT_DIR:-models/peak_slot_v5_120s_ponytail_cuda}
RESUME=${RESUME:-models/peak_slot_profile_only_120s_unetprior_cuda/checkpoint_best.pt}
DEVICE=${DEVICE:-cuda}
EPOCHS=${EPOCHS:-80}
