...
def main() -> int:
    ...
    if family == "peak_slot":
        ...
        model, checkpoint = pk.load_checkpoint_model(args.model, device=str(args.device).strip() or None)
        infer_cfg = pk.InferenceConfig(
            ...
            peak_threshold=float(args.visibility_threshold),
