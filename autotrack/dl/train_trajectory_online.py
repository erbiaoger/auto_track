...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--sigma-min-s", type=float, default=0.25, help="Minimum pulse sigma in seconds.")
    parser.add_argument("--sigma-max-s", type=float, default=0.25, help="Maximum pulse sigma in seconds.")
